...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-glow-dark-teal opacity-15 pointer-events-none" />
                ...
                >
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-white/10 mb-3 mx-auto relative group">
                    {presenter.image ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-bhf-teal/20 to-bhf-dark-teal/20 flex items-center justify-center">
            ...
            {workshopInfo.agenda.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Icon size={14} className="text-bhf-teal/70" />
                  </div>

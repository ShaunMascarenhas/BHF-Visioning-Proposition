      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <Target size={20} className="text-bh-teal" />
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{
                background:
                  viewMode === 'raw'
                    ? 'linear-gradient(135deg, rgba(0,176,185,0.15), rgba(117,59,189,0.1))'
            ...
            <button
              ...
              style={{
                background:
                  viewMode === 'cleaned'
                    ? 'linear-gradient(135deg, rgba(117,59,189,0.2), rgba(255,195,4,0.15))'
                    : 'rgba(255,255,255,0.03)',
                color:
                  viewMode === 'cleaned'
                    ? '#753BBD'
                    : 'rgba(255,255,255,0.4)',
                border: `1px solid ${viewMode === 'cleaned' ? 'rgba(117,59,189,0.3)' : 'rgba(255,255,255,0.08)'}`,
              }}
            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(0,176,185,0.15), rgba(117,59,189,0.15))',
          ...
          >
            <GlassCard className="p-8 inline-block">
              <div className="flex items-center gap-8">
                ...
                <div className="text-center">
                  <p className="font-heading text-3xl font-bold text-bh-violet">
                    {totalVotes}
                  </p>
                ...
                <div className="w-px h-12 bg-white/10" />
                <div className="text-center">
                  <p className="font-heading text-3xl font-bold text-bh-gold">

...
function FactorsSlide({ domain }) {
  return (
    <div className="h-full flex items-center justify-center px-8 pt-28 pb-24">
      <div className="max-w-5xl w-full">
        ...
        <motion.h2
          ...
          className="font-heading text-2xl font-bold text-white mb-5"
        >
          Factors Shaping{' '}
        ...
        <div className="space-y-0">
          {domain.factors.map((factor, i) => (
            ...
            >
              ...
              <div className="flex-1 py-3.5 pr-8">
                <h3 className="font-heading font-semibold text-white/90 text-xl truncate mb-0.5">
                  {factor.name}
                </h3>
                <p className="text-white/40 text-[13px] leading-snug line-clamp-2">
                  {factor.description}
                </p>
              </div>
              ...
              {/* Right: stat block */}
              <div
                className="w-44 md:w-56 flex-shrink-0 flex flex-col items-center justify-center py-3.5 pl-6 border-l border-white/[0.06]"
              >
                <span
                ...
                <p className="text-white/35 text-[11px] mt-1.5 leading-snug text-center line-clamp-2">
                  {factor.statLabel}
                </p>
              </div>
            </motion.div>
